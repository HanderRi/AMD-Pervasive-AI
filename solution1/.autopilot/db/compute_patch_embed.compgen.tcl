...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { patch_embed_bias_address0 { O 5 vector } patch_embed_bias_ce0 { O 1 bit } patch_embed_bias_q0 { I 128 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { patch_embed_weights_address0 { O 11 vector } patch_embed_weights_ce0 { O 1 bit } patch_embed_weights_q0 { I 2048 vector } } \
} "
} else {
