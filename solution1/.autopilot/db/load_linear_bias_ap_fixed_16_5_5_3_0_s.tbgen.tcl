set moduleName load_linear_bias_ap_fixed_16_5_5_3_0_s
set isTopModule 0
...
set C_modelArgMapList {[ 
	{ "Name" : "bias_dst", "interface" : "memory", "bitwidth" : 288, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "out_dim_offset", "interface" : "wire", "bitwidth" : 9, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ bias_dst_address0 sc_out sc_lv 6 signal 0 } 
	{ bias_dst_ce0 sc_out sc_logic 1 signal 0 } 
	{ bias_dst_we0 sc_out sc_logic 1 signal 0 } 
	{ bias_dst_d0 sc_out sc_lv 288 signal 0 } 
	...
	{ bias_src sc_in sc_lv 64 signal 2 } 
	{ out_dim_offset sc_in sc_lv 9 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "out_dim_offset", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "out_dim_offset", "role": "default" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "bias_dst", "Type" : "Memory", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_load_linear_bias_ap_fixed_16_5_5_3_0_Pipeline_ln130_for_each_src_block_fu_86", "Port" : "bias_dst", "Inst_start_state" : "1", "Inst_end_state" : "2"}]},
			{"Name" : "weights", "Type" : "MAXI", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_load_linear_bias_ap_fixed_16_5_5_3_0_Pipeline_ln130_for_each_src_block_fu_86", "Port" : "weights", "Inst_start_state" : "1", "Inst_end_state" : "2"}]},
			{"Name" : "bias_src", "Type" : "None", "Direction" : "I"},
			{"Name" : "out_dim_offset", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_load_linear_bias_ap_fixed_16_5_5_3_0_Pipeline_ln130_for_each_src_block_fu_86", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_load_linear_bias_ap_fixed_16_5_5_3_0_Pipeline_ln130_for_each_src_block_fu_86.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	...
	out_dim_offset { ap_none {  { out_dim_offset in_data 0 9 } } }
}
