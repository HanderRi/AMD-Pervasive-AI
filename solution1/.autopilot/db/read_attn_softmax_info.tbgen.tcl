set moduleName read_attn_softmax_info
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {read_attn_softmax_info}
...
set portList { 
	...
	{ attn_softmax_info_stream_din sc_out sc_lv 256 signal 0 } 
	{ attn_softmax_info_stream_num_data_valid sc_in sc_lv 2 signal 0 } 
	{ attn_softmax_info_stream_fifo_cap sc_in sc_lv 2 signal 0 } 
	{ attn_softmax_info_stream_full_n sc_in sc_logic 1 signal 0 } 
	{ attn_softmax_info_stream_write sc_out sc_logic 1 signal 0 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "attn_softmax_info_stream", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_read_attn_softmax_info_Pipeline_ln388_for_each_q_patch_fu_55", "Port" : "attn_softmax_info_stream", "Inst_start_state" : "8", "Inst_end_state" : "9"}]},
			{"Name" : "inout4", "Type" : "MAXI", "Direction" : "I",
				"BlockSignal" : [
					{"Name" : "inout4_blk_n_AR", "Type" : "RtlSignal"}],
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_read_attn_softmax_info_Pipeline_ln388_for_each_q_patch_fu_55", "Port" : "inout4", "Inst_start_state" : "8", "Inst_end_state" : "9"}]},
			{"Name" : "attn_softmax_info", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_read_attn_softmax_info_Pipeline_ln388_for_each_q_patch_fu_55", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_read_attn_softmax_info_Pipeline_ln388_for_each_q_patch_fu_55.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
