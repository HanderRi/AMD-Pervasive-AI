...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { zext_ln137_10 { I 8 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { zext_ln137_11 { I 8 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { zext_ln137_12 { I 8 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { zext_ln137_13 { I 8 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { zext_ln137_14 { I 8 vector } } \
} "
}
