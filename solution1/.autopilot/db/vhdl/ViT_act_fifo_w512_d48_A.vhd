...
entity ViT_act_fifo_w512_d48_A is
    generic (
...
architecture arch of ViT_act_fifo_w512_d48_A is

    -- component
    component ViT_act_fifo_w512_d48_A_ram is
    generic (
        MEM_STYLE  : string  := "auto";
...
begin
----------------------- Instantiation -----------------------
    U_ViT_act_fifo_w512_d48_A_ram : ViT_act_fifo_w512_d48_A_ram
    generic map (
        MEM_STYLE  => MEM_STYLE,
...
entity ViT_act_fifo_w512_d48_A_ram is
    generic (
        MEM_STYLE   : string  := "auto";
        DATA_WIDTH  : integer := 512;
        ADDR_WIDTH  : integer := 6;
...
architecture arch of ViT_act_fifo_w512_d48_A_ram is
