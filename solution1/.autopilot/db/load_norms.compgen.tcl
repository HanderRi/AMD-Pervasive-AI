...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename norm1_bias \
    op interface \
    ports { norm1_bias_address0 { O 5 vector } norm1_bias_ce0 { O 1 bit } norm1_bias_we0 { O 1 bit } norm1_bias_d0 { O 128 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'norm1_bias'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir O \
    corename norm1_weights \
    op interface \
    ports { norm1_weights_address0 { O 5 vector } norm1_weights_ce0 { O 1 bit } norm1_weights_we0 { O 1 bit } norm1_weights_d0 { O 128 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'norm1_weights'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_norm_weights \
    op interface \
    ports { norm_weights { I 64 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_norm_bias \
    op interface \
    ports { norm_bias { I 64 vector } } \
} "
}
