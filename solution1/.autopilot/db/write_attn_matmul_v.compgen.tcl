...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { attn_matmul_v_dout { I 64 vector } attn_matmul_v_num_data_valid { I 4 vector } attn_matmul_v_fifo_cap { I 4 vector } attn_matmul_v_empty_n { I 1 bit } attn_matmul_v_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { attn_matmul_v_stream_dout { I 256 vector } attn_matmul_v_stream_num_data_valid { I 2 vector } attn_matmul_v_stream_fifo_cap { I 2 vector } attn_matmul_v_stream_empty_n { I 1 bit } attn_matmul_v_stream_read { O 1 bit } } \
} "
}
