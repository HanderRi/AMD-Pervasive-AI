set moduleName write_attn_Pipeline_ln245_for_each_q_patch_block_ln247_for_each_k_patch_ln249
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {write_attn_Pipeline__ln245_for_each_q_patch_block__ln247_for_each_k_patch__ln249}
set C_modelType { void 0 }
set C_modelArgList {
	{ attn_stream int 128 regular {fifo 0 volatile }  }
	{ attn_load int 64 regular  }
	{ trunc_ln252_1 int 5 regular  }
	{ inout1 int 256 regular {axi_master 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "attn_stream", "interface" : "fifo", "bitwidth" : 128, "direction" : "READONLY"} , 
 	{ "Name" : "attn_load", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "trunc_ln252_1", "interface" : "wire", "bitwidth" : 5, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ attn_load sc_in sc_lv 64 signal 1 } 
	{ trunc_ln252_1 sc_in sc_lv 5 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "attn_load", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "attn_load", "role": "default" }} , 
 	{ "name": "trunc_ln252_1", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "trunc_ln252_1", "role": "default" }}  ]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "17036", "Max" : "17036"}
	, {"Name" : "Interval", "Min" : "17036", "Max" : "17036"}
]}
...
set Spec2ImplPortList { 
	...
	attn_load { ap_none {  { attn_load in_data 0 64 } } }
	trunc_ln252_1 { ap_none {  { trunc_ln252_1 in_data 0 5 } } }
