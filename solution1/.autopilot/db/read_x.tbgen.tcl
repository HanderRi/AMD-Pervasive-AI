...
set hasInterrupt 0
set C_modelName {read_x}
set C_modelType { void 0 }
set C_modelArgList {
	{ q_stream int 256 regular {fifo 1 volatile }  }
	{ inout2 int 256 regular {axi_master 0}  }
	{ x int 64 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "q_stream", "interface" : "fifo", "bitwidth" : 256, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ q_stream_din sc_out sc_lv 256 signal 0 } 
	{ q_stream_num_data_valid sc_in sc_lv 2 signal 0 } 
	{ q_stream_fifo_cap sc_in sc_lv 2 signal 0 } 
	{ q_stream_full_n sc_in sc_logic 1 signal 0 } 
	{ q_stream_write sc_out sc_logic 1 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "q_stream_din", "direction": "out", "datatype": "sc_lv", "bitwidth":256, "type": "signal", "bundle":{"name": "q_stream", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "q_stream", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_read_x_Pipeline_ln18_for_each_patch_ln20_for_block_in_dim_fu_55", "Port" : "q_stream", "Inst_start_state" : "8", "Inst_end_state" : "9"}]},
			{"Name" : "inout2", "Type" : "MAXI", "Direction" : "I",
				"BlockSignal" : [
					{"Name" : "inout2_blk_n_AR", "Type" : "RtlSignal"}],
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_read_x_Pipeline_ln18_for_each_patch_ln20_for_block_in_dim_fu_55", "Port" : "inout2", "Inst_start_state" : "8", "Inst_end_state" : "9"}]},
			{"Name" : "x", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_read_x_Pipeline_ln18_for_each_patch_ln20_for_block_in_dim_fu_55", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_read_x_Pipeline_ln18_for_each_patch_ln20_for_block_in_dim_fu_55.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	q_stream { ap_fifo {  { q_stream_din fifo_port_we 1 256 }  { q_stream_num_data_valid fifo_status_num_data_valid 0 2 }  { q_stream_fifo_cap fifo_update 0 2 }  { q_stream_full_n fifo_status 0 1 }  { q_stream_write fifo_data 1 1 } } }
