set moduleName write_attn_matmul_v
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {write_attn_matmul_v}
set C_modelType { void 0 }
set C_modelArgList {
	{ inout1 int 256 regular {axi_master 1}  }
	{ attn_matmul_v int 64 regular {fifo 0}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "inout1", "interface" : "axi_master", "bitwidth" : 256, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "images","offset": { "type": "dynamic","port_name": "images","bundle": "control"},"direction": "READONLY"},{"cName": "tmp1","offset": { "type": "dynamic","port_name": "tmp1","bundle": "control"},"direction": "READWRITE"},{"cName": "attn","offset": { "type": "dynamic","port_name": "attn","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "attn_matmul_v", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ attn_matmul_v_dout sc_in sc_lv 64 signal 1 } 
	{ attn_matmul_v_num_data_valid sc_in sc_lv 4 signal 1 } 
	{ attn_matmul_v_fifo_cap sc_in sc_lv 4 signal 1 } 
	{ attn_matmul_v_empty_n sc_in sc_logic 1 signal 1 } 
	{ attn_matmul_v_read sc_out sc_logic 1 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "attn_matmul_v_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "attn_matmul_v", "role": "dout" }} , 
 	{ "name": "attn_matmul_v_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "attn_matmul_v", "role": "num_data_valid" }} , 
 	{ "name": "attn_matmul_v_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "attn_matmul_v", "role": "fifo_cap" }} , 
 	{ "name": "attn_matmul_v_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "attn_matmul_v", "role": "empty_n" }} , 
 	{ "name": "attn_matmul_v_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "attn_matmul_v", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "inout1", "Type" : "MAXI", "Direction" : "O",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_write_attn_matmul_v_Pipeline_ln403_for_each_patch_ln405_for_block_dim_fu_66", "Port" : "inout1", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "attn_matmul_v", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "5", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "attn_matmul_v_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "attn_matmul_v_stream", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_write_attn_matmul_v_Pipeline_ln403_for_each_patch_ln405_for_block_dim_fu_66", "Port" : "attn_matmul_v_stream", "Inst_start_state" : "3", "Inst_end_state" : "4"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_write_attn_matmul_v_Pipeline_ln403_for_each_patch_ln405_for_block_dim_fu_66", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_write_attn_matmul_v_Pipeline_ln403_for_each_patch_ln405_for_block_dim_fu_66.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "3107", "Max" : "3107"}
	, {"Name" : "Interval", "Min" : "3107", "Max" : "3107"}
]}
...
set Spec2ImplPortList { 
	...
	attn_matmul_v { ap_fifo {  { attn_matmul_v_dout fifo_port_we 0 64 }  { attn_matmul_v_num_data_valid fifo_status_num_data_valid 0 4 }  { attn_matmul_v_fifo_cap fifo_update 0 4 }  { attn_matmul_v_empty_n fifo_status 0 1 }  { attn_matmul_v_read fifo_data 1 1 } } }
