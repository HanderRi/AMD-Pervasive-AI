set moduleName read_in_stream_direct
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {read_in_stream_direct}
set C_modelType { void 0 }
set C_modelArgList {
	{ in_stream int 512 regular {fifo 1 volatile }  }
	{ inout1 int 256 regular {axi_master 0}  }
	{ src int 64 regular  }
	{ in_dim_offset int 10 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "in_stream", "interface" : "fifo", "bitwidth" : 512, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ in_stream_din sc_out sc_lv 512 signal 0 } 
	{ in_stream_num_data_valid sc_in sc_lv 7 signal 0 } 
	{ in_stream_fifo_cap sc_in sc_lv 7 signal 0 } 
	{ in_stream_full_n sc_in sc_logic 1 signal 0 } 
	{ in_stream_write sc_out sc_logic 1 signal 0 } 
	...
	{ src sc_in sc_lv 64 signal 2 } 
	{ in_dim_offset sc_in sc_lv 10 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "in_stream_din", "direction": "out", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "in_stream", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "in_stream", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "48", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_read_in_stream_direct_Pipeline_ln181_for_each_i_fu_74", "Port" : "in_stream", "Inst_start_state" : "9", "Inst_end_state" : "10"}]},
			{"Name" : "inout1", "Type" : "MAXI", "Direction" : "I",
				"BlockSignal" : [
					{"Name" : "inout1_blk_n_AR", "Type" : "RtlSignal"}],
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_read_in_stream_direct_Pipeline_ln181_for_each_i_fu_74", "Port" : "inout1", "Inst_start_state" : "9", "Inst_end_state" : "10"}]},
			{"Name" : "src", "Type" : "None", "Direction" : "I"},
			{"Name" : "in_dim_offset", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_read_in_stream_direct_Pipeline_ln181_for_each_i_fu_74", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_read_in_stream_direct_Pipeline_ln181_for_each_i_fu_74.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	in_stream { ap_fifo {  { in_stream_din fifo_port_we 1 512 }  { in_stream_num_data_valid fifo_status_num_data_valid 0 7 }  { in_stream_fifo_cap fifo_update 0 7 }  { in_stream_full_n fifo_status 0 1 }  { in_stream_write fifo_data 1 1 } } }
