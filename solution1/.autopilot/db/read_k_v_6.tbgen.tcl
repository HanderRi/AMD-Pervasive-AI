...
set hasInterrupt 0
set C_modelName {read_k_v.6}
set C_modelType { void 0 }
set C_modelArgList {
	{ v_stream int 256 regular {fifo 1 volatile }  }
	{ inout2 int 256 regular {axi_master 0}  }
	{ k int 64 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "v_stream", "interface" : "fifo", "bitwidth" : 256, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ v_stream_din sc_out sc_lv 256 signal 0 } 
	{ v_stream_num_data_valid sc_in sc_lv 2 signal 0 } 
	{ v_stream_fifo_cap sc_in sc_lv 2 signal 0 } 
	{ v_stream_full_n sc_in sc_logic 1 signal 0 } 
	{ v_stream_write sc_out sc_logic 1 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "v_stream_din", "direction": "out", "datatype": "sc_lv", "bitwidth":256, "type": "signal", "bundle":{"name": "v_stream", "role": "din" }} , 
 	...
 	{ "name": "v_stream_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "v_stream", "role": "full_n" }} , 
 	{ "name": "v_stream_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "v_stream", "role": "write" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "v_stream", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	v_stream { ap_fifo {  { v_stream_din fifo_port_we 1 256 }  { v_stream_num_data_valid fifo_status_num_data_valid 0 2 }  { v_stream_fifo_cap fifo_update 0 2 }  { v_stream_full_n fifo_status 0 1 }  { v_stream_write fifo_data 1 1 } } }
