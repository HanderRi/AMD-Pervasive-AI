set moduleName write_out_stream_direct
set isTopModule 0
...
set C_modelArgMapList {[ 
	{ "Name" : "inout2", "interface" : "axi_master", "bitwidth" : 256, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "x","offset": { "type": "dynamic","port_name": "x","bundle": "control"},"direction": "READWRITE"},{"cName": "tmp2","offset": { "type": "dynamic","port_name": "tmp2","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	...
 	{ "Name" : "out_dim_offset", "interface" : "fifo", "bitwidth" : 10, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ dst_dout sc_in sc_lv 64 signal 1 } 
	{ dst_num_data_valid sc_in sc_lv 3 signal 1 } 
	{ dst_fifo_cap sc_in sc_lv 3 signal 1 } 
	{ dst_empty_n sc_in sc_logic 1 signal 1 } 
	{ dst_read sc_out sc_logic 1 signal 1 } 
	{ out_stream_dout sc_in sc_lv 512 signal 2 } 
	{ out_stream_num_data_valid sc_in sc_lv 2 signal 2 } 
	{ out_stream_fifo_cap sc_in sc_lv 2 signal 2 } 
	{ out_stream_empty_n sc_in sc_logic 1 signal 2 } 
	{ out_stream_read sc_out sc_logic 1 signal 2 } 
	{ out_dim_offset_dout sc_in sc_lv 10 signal 3 } 
	{ out_dim_offset_num_data_valid sc_in sc_lv 2 signal 3 } 
	{ out_dim_offset_fifo_cap sc_in sc_lv 2 signal 3 } 
	{ out_dim_offset_empty_n sc_in sc_logic 1 signal 3 } 
	{ out_dim_offset_read sc_out sc_logic 1 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "out_dim_offset_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "out_dim_offset", "role": "dout" }} , 
 	{ "name": "out_dim_offset_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "out_dim_offset", "role": "num_data_valid" }} , 
 	{ "name": "out_dim_offset_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "out_dim_offset", "role": "fifo_cap" }} , 
 	{ "name": "out_dim_offset_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "out_dim_offset", "role": "empty_n" }} , 
 	{ "name": "out_dim_offset_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "out_dim_offset", "role": "read" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "inout2", "Type" : "MAXI", "Direction" : "O",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_write_out_stream_direct_Pipeline_ln231_for_each_i_fu_85", "Port" : "inout2", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			...
			{"Name" : "out_stream", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_write_out_stream_direct_Pipeline_ln231_for_each_i_fu_85", "Port" : "out_stream", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "out_dim_offset", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "out_dim_offset_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_write_out_stream_direct_Pipeline_ln231_for_each_i_fu_85", "Parent" : "0", "Child" : ["2", "3", "4", "5", "6", "7", "8", "9", "10"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_write_out_stream_direct_Pipeline_ln231_for_each_i_fu_85.mux_21_32_1_1_U806", "Parent" : "1"},
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_write_out_stream_direct_Pipeline_ln231_for_each_i_fu_85.mux_21_32_1_1_U807", "Parent" : "1"},
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_write_out_stream_direct_Pipeline_ln231_for_each_i_fu_85.mux_21_32_1_1_U808", "Parent" : "1"},
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_write_out_stream_direct_Pipeline_ln231_for_each_i_fu_85.mux_21_32_1_1_U809", "Parent" : "1"},
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_write_out_stream_direct_Pipeline_ln231_for_each_i_fu_85.mux_21_32_1_1_U810", "Parent" : "1"},
	{"ID" : "7", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_write_out_stream_direct_Pipeline_ln231_for_each_i_fu_85.mux_21_32_1_1_U811", "Parent" : "1"},
	{"ID" : "8", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_write_out_stream_direct_Pipeline_ln231_for_each_i_fu_85.mux_21_32_1_1_U812", "Parent" : "1"},
	{"ID" : "9", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_write_out_stream_direct_Pipeline_ln231_for_each_i_fu_85.mux_21_32_1_1_U813", "Parent" : "1"},
	{"ID" : "10", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_write_out_stream_direct_Pipeline_ln231_for_each_i_fu_85.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	...
	out_dim_offset { ap_fifo {  { out_dim_offset_dout fifo_port_we 0 10 }  { out_dim_offset_num_data_valid fifo_status_num_data_valid 0 2 }  { out_dim_offset_fifo_cap fifo_update 0 2 }  { out_dim_offset_empty_n fifo_status 0 1 }  { out_dim_offset_read fifo_data 1 1 } } }
}
