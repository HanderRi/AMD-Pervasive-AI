set moduleName read_in_stream_direct_Pipeline_ln181_for_each_i
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {read_in_stream_direct_Pipeline__ln181_for_each_i}
set C_modelType { void 0 }
set C_modelArgList {
	{ inout1 int 256 regular {axi_master 0}  }
	{ sext_ln181_i int 59 regular  }
	{ iters_i int 16 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "inout1", "interface" : "axi_master", "bitwidth" : 256, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "images","offset": { "type": "dynamic","port_name": "images","bundle": "control"},"direction": "READONLY"},{"cName": "tmp1","offset": { "type": "dynamic","port_name": "tmp1","bundle": "control"},"direction": "READWRITE"},{"cName": "attn","offset": { "type": "dynamic","port_name": "attn","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "sext_ln181_i", "interface" : "wire", "bitwidth" : 59, "direction" : "READONLY"} , 
 	{ "Name" : "iters_i", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ in_stream_din sc_out sc_lv 512 signal 3 } 
	{ in_stream_num_data_valid sc_in sc_lv 7 signal 3 } 
	{ in_stream_fifo_cap sc_in sc_lv 7 signal 3 } 
	{ in_stream_full_n sc_in sc_logic 1 signal 3 } 
	{ in_stream_write sc_out sc_logic 1 signal 3 } 
	{ sext_ln181_i sc_in sc_lv 59 signal 1 } 
	{ iters_i sc_in sc_lv 16 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln181_i", "direction": "in", "datatype": "sc_lv", "bitwidth":59, "type": "signal", "bundle":{"name": "sext_ln181_i", "role": "default" }} , 
 	{ "name": "iters_i", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "iters_i", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	...
	sext_ln181_i { ap_none {  { sext_ln181_i in_data 0 59 } } }
	iters_i { ap_none {  { iters_i in_data 0 16 } } }
