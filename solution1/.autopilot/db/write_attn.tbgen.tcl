...
set C_modelArgMapList {[ 
	{ "Name" : "attn_stream", "interface" : "fifo", "bitwidth" : 128, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "attn", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ attn_dout sc_in sc_lv 64 signal 2 } 
	{ attn_num_data_valid sc_in sc_lv 4 signal 2 } 
	{ attn_fifo_cap sc_in sc_lv 4 signal 2 } 
	{ attn_empty_n sc_in sc_logic 1 signal 2 } 
	{ attn_read sc_out sc_logic 1 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "attn_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "attn", "role": "dout" }} , 
 	{ "name": "attn_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "attn", "role": "num_data_valid" }} , 
 	{ "name": "attn_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "attn", "role": "fifo_cap" }} , 
 	{ "name": "attn_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "attn", "role": "empty_n" }} , 
 	{ "name": "attn_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "attn", "role": "read" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "attn_stream", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_write_attn_Pipeline_ln245_for_each_q_patch_block_ln247_for_each_k_patch_ln249_fu_46", "Port" : "attn_stream", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			{"Name" : "inout1", "Type" : "MAXI", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_write_attn_Pipeline_ln245_for_each_q_patch_block_ln247_for_each_k_patch_ln249_fu_46", "Port" : "inout1", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			{"Name" : "attn", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "5", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "attn_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_write_attn_Pipeline_ln245_for_each_q_patch_block_ln247_for_each_k_patch_ln249_fu_46", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_write_attn_Pipeline_ln245_for_each_q_patch_block_ln247_for_each_k_patch_ln249_fu_46.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	...
	attn { ap_fifo {  { attn_dout fifo_port_we 0 64 }  { attn_num_data_valid fifo_status_num_data_valid 0 4 }  { attn_fifo_cap fifo_update 0 4 }  { attn_empty_n fifo_status 0 1 }  { attn_read fifo_data 1 1 } } }
}
