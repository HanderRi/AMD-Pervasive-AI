...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_image_stream \
    op interface \
    ports { image_stream_din { O 256 vector } image_stream_num_data_valid { I 2 vector } image_stream_fifo_cap { I 2 vector } image_stream_full_n { I 1 bit } image_stream_write { O 1 bit } } \
} "
}
