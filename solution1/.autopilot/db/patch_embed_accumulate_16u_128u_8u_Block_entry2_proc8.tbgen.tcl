set moduleName patch_embed_accumulate_16u_128u_8u_Block_entry2_proc8
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {patch_embed_accumulate<16u, 128u, 8u>_Block_entry2_proc8}
...
set portList { 
	...
	{ y_block sc_in sc_lv 3 signal 0 } 
