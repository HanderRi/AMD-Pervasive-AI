...
# ==============================================================
set ::env(PATH) "$::env(PATH);E:/Xilinx/Vitis_HLS/2022.2/win64/tools/fpo_v7_1"
set ::env(PATH) "$::env(PATH);E:/Xilinx/Vitis_HLS/2022.2/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);E:/Xilinx/Vitis_HLS/2022.2/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);E:/Xilinx/Vitis_HLS/2022.2/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "ViT_act.autotvin.dat"
	set constFileTvOut       "ViT_act.autotvout.dat"
	set constFileHdlTvIn     "ViT_act.autohdltvin.dat"
	set constFileHdlTvOut    "ViT_act.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
