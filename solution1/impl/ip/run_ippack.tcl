...
set IPName      "ViT_act"
set Version     "1.0"
set DisplayName "Vit_act"
set Revision    "2113669899"
...
set xo_kernel_name "ViT_act"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "E:/DeiTCPP/Deit_cpp/solution1"
set debug_dir "E:/DeiTCPP/Deit_cpp/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {ViT_act_flow_control_loop_pipe_sequential_init
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL RW 0x0 {Control signals} {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 1 RESERVED_2 R 0 "Reserved.  0s on read." } { 9 1 INTERRUPT R 0 "Control signal Register for 'interrupt'." } { 10 22 RESERVED_3 R 0 "Reserved.  0s on read." }}} {0x04 GIER RW 0x0 {Global Interrupt Enable Register} {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }}} {0x08 IP_IER RW 0x0 {IP Interrupt Enable Register} {{0 1 CHAN0_INT_EN RW 0 {Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled.}} {1 1 CHAN1_INT_EN RW 0 {Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x0c IP_ISR RW 0x0 {IP Interrupt Status Register} {{0 1 CHAN0_INT_ST RTOW 0 {Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 interrupt, 1 = Channel 0 interrupt.}} {1 1 CHAN1_INT_ST RTOW 0 {Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 interrupt, 1 = Channel 1 interrupt.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x10 images_1 W 0x0 "Data signal of images" {{0 32 images W 0 "Bit 31 to 0 of images"}}} {0x14 images_2 W 0x0 "Data signal of images" {{0 32 images W 0 "Bit 63 to 32 of images"}}} {0x1c x_1 W 0x0 "Data signal of x" {{0 32 x W 0 "Bit 31 to 0 of x"}}} {0x20 x_2 W 0x0 "Data signal of x" {{0 32 x W 0 "Bit 63 to 32 of x"}}} {0x28 tmp1_1 W 0x0 "Data signal of tmp1" {{0 32 tmp1 W 0 "Bit 31 to 0 of tmp1"}}} {0x2c tmp1_2 W 0x0 "Data signal of tmp1" {{0 32 tmp1 W 0 "Bit 63 to 32 of tmp1"}}} {0x34 tmp2_1 W 0x0 "Data signal of tmp2" {{0 32 tmp2 W 0 "Bit 31 to 0 of tmp2"}}} {0x38 tmp2_2 W 0x0 "Data signal of tmp2" {{0 32 tmp2 W 0 "Bit 63 to 32 of tmp2"}}} {0x40 tmp3_1 W 0x0 "Data signal of tmp3" {{0 32 tmp3 W 0 "Bit 31 to 0 of tmp3"}}} {0x44 tmp3_2 W 0x0 "Data signal of tmp3" {{0 32 tmp3 W 0 "Bit 63 to 32 of tmp3"}}} {0x4c tmp_hidden_1 W 0x0 "Data signal of tmp_hidden" {{0 32 tmp_hidden W 0 "Bit 31 to 0 of tmp_hidden"}}} {0x50 tmp_hidden_2 W 0x0 "Data signal of tmp_hidden" {{0 32 tmp_hidden W 0 "Bit 63 to 32 of tmp_hidden"}}} {0x58 attn_1 W 0x0 "Data signal of attn" {{0 32 attn W 0 "Bit 31 to 0 of attn"}}} {0x5c attn_2 W 0x0 "Data signal of attn" {{0 32 attn W 0 "Bit 63 to 32 of attn"}}} {0x64 attn_softmax_info_1 W 0x0 "Data signal of attn_softmax_info" {{0 32 attn_softmax_info W 0 "Bit 31 to 0 of attn_softmax_info"}}} {0x68 attn_softmax_info_2 W 0x0 "Data signal of attn_softmax_info" {{0 32 attn_softmax_info W 0 "Bit 63 to 32 of attn_softmax_info"}}} {0x70 patch_embed_weights_1 W 0x0 "Data signal of patch_embed_weights" {{0 32 patch_embed_weights W 0 "Bit 31 to 0 of patch_embed_weights"}}} {0x74 patch_embed_weights_2 W 0x0 "Data signal of patch_embed_weights" {{0 32 patch_embed_weights W 0 "Bit 63 to 32 of patch_embed_weights"}}} {0x7c patch_embed_bias_1 W 0x0 "Data signal of patch_embed_bias" {{0 32 patch_embed_bias W 0 "Bit 31 to 0 of patch_embed_bias"}}} {0x80 patch_embed_bias_2 W 0x0 "Data signal of patch_embed_bias" {{0 32 patch_embed_bias W 0 "Bit 63 to 32 of patch_embed_bias"}}} {0x88 pos_embed_1 W 0x0 "Data signal of pos_embed" {{0 32 pos_embed W 0 "Bit 31 to 0 of pos_embed"}}} {0x8c pos_embed_2 W 0x0 "Data signal of pos_embed" {{0 32 pos_embed W 0 "Bit 63 to 32 of pos_embed"}}} {0x94 attn_weights_1 W 0x0 "Data signal of attn_weights" {{0 32 attn_weights W 0 "Bit 31 to 0 of attn_weights"}}} {0x98 attn_weights_2 W 0x0 "Data signal of attn_weights" {{0 32 attn_weights W 0 "Bit 63 to 32 of attn_weights"}}} {0xa0 attn_bias_1 W 0x0 "Data signal of attn_bias" {{0 32 attn_bias W 0 "Bit 31 to 0 of attn_bias"}}} {0xa4 attn_bias_2 W 0x0 "Data signal of attn_bias" {{0 32 attn_bias W 0 "Bit 63 to 32 of attn_bias"}}} {0xac vit_weights_l1_1 W 0x0 "Data signal of vit_weights_l1" {{0 32 vit_weights_l1 W 0 "Bit 31 to 0 of vit_weights_l1"}}} {0xb0 vit_weights_l1_2 W 0x0 "Data signal of vit_weights_l1" {{0 32 vit_weights_l1 W 0 "Bit 63 to 32 of vit_weights_l1"}}} {0xb8 vit_bias_l1_1 W 0x0 "Data signal of vit_bias_l1" {{0 32 vit_bias_l1 W 0 "Bit 31 to 0 of vit_bias_l1"}}} {0xbc vit_bias_l1_2 W 0x0 "Data signal of vit_bias_l1" {{0 32 vit_bias_l1 W 0 "Bit 63 to 32 of vit_bias_l1"}}} {0xc4 vit_weights_l2_1 W 0x0 "Data signal of vit_weights_l2" {{0 32 vit_weights_l2 W 0 "Bit 31 to 0 of vit_weights_l2"}}} {0xc8 vit_weights_l2_2 W 0x0 "Data signal of vit_weights_l2" {{0 32 vit_weights_l2 W 0 "Bit 63 to 32 of vit_weights_l2"}}} {0xd0 vit_bias_l2_1 W 0x0 "Data signal of vit_bias_l2" {{0 32 vit_bias_l2 W 0 "Bit 31 to 0 of vit_bias_l2"}}} {0xd4 vit_bias_l2_2 W 0x0 "Data signal of vit_bias_l2" {{0 32 vit_bias_l2 W 0 "Bit 63 to 32 of vit_bias_l2"}}} {0xdc norm_weights_1 W 0x0 "Data signal of norm_weights" {{0 32 norm_weights W 0 "Bit 31 to 0 of norm_weights"}}} {0xe0 norm_weights_2 W 0x0 "Data signal of norm_weights" {{0 32 norm_weights W 0 "Bit 63 to 32 of norm_weights"}}} {0xe8 norm_bias_1 W 0x0 "Data signal of norm_bias" {{0 32 norm_bias W 0 "Bit 31 to 0 of norm_bias"}}} {0xec norm_bias_2 W 0x0 "Data signal of norm_bias" {{0 32 norm_bias W 0 "Bit 63 to 32 of norm_bias"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_control m_axi_inout1 m_axi_inout2 m_axi_inout3 m_axi_inout4 m_axi_weights"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_inout1 {
        ...
        data_width "256"
        port_prefix "m_axi_inout1"
        param_prefix "C_M_AXI_INOUT1"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 256 WSTRB 32 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 256 RID 1 RUSER 1 BID 1 BUSER 1"
        HasOffset "1"
        has_dependant_on "1"
    ...
    m_axi_inout2 {
        ...
        data_width "256"
        port_prefix "m_axi_inout2"
        param_prefix "C_M_AXI_INOUT2"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 256 WSTRB 32 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 256 RID 1 RUSER 1 BID 1 BUSER 1"
        HasOffset "1"
        has_dependant_on "1"
        offset_slave_name "s_axi_control"
    ...
    m_axi_inout3 {
        ...
        data_width "256"
        port_prefix "m_axi_inout3"
        param_prefix "C_M_AXI_INOUT3"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 256 WSTRB 32 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 256 RID 1 RUSER 1 BID 1 BUSER 1"
        HasOffset "1"
        has_dependant_on "1"
        offset_slave_name "s_axi_control"
    ...
    m_axi_inout4 {
        ...
        data_width "256"
        port_prefix "m_axi_inout4"
        param_prefix "C_M_AXI_INOUT4"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 256 WSTRB 32 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 256 RID 1 RUSER 1 BID 1 BUSER 1"
        HasOffset "1"
        has_dependant_on "1"
        offset_slave_name "s_axi_control"
    ...
    m_axi_weights {
        ...
        data_width "256"
        port_prefix "m_axi_weights"
        param_prefix "C_M_AXI_WEIGHTS"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 256 WSTRB 32 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 256 RID 1 RUSER 1 BID 1 BUSER 1"
        HasOffset "1"
        has_dependant_on "1"
        offset_slave_name "s_axi_control"
...
source -notrace "E:/Xilinx/Vitis_HLS/2022.2/common/scripts/ipxhls.tcl"
