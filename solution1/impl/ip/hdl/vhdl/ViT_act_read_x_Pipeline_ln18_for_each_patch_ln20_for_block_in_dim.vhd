...
entity ViT_act_read_x_Pipeline_ln18_for_each_patch_ln20_for_block_in_dim is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of ViT_act_read_x_Pipeline_ln18_for_each_patch_ln20_for_block_in_dim is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln18_reg_119 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal inout2_addr_read_reg_123 : STD_LOGIC_VECTOR (255 downto 0);
    signal ap_condition_exit_pp0_iter1_stage0 : STD_LOGIC;
    signal indvar_flatten_fu_50 : STD_LOGIC_VECTOR (11 downto 0);
    signal add_ln18_fu_90_p2 : STD_LOGIC_VECTOR (11 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln18_fu_84_p2 = ap_const_lv1_0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln18_reg_119 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
    ...
    add_ln18_fu_90_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_indvar_flatten_load) + unsigned(ap_const_lv12_1));
    ap_CS_fsm_pp0_stage0 <= ap_CS_fsm(0);
        ap_block_pp0_stage0 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_pp0_stage0_01001_assign_proc : process(ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, m_axi_inout2_RVALID, icmp_ln18_reg_119, q_stream_full_n)
    begin
                ap_block_pp0_stage0_01001 <= (((q_stream_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1)) or ((icmp_ln18_reg_119 = ap_const_lv1_0) and (m_axi_inout2_RVALID = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, m_axi_inout2_RVALID, icmp_ln18_reg_119, q_stream_full_n)
    begin
                ap_block_pp0_stage0_11001 <= (((q_stream_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1)) or ((icmp_ln18_reg_119 = ap_const_lv1_0) and (m_axi_inout2_RVALID = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, m_axi_inout2_RVALID, icmp_ln18_reg_119, q_stream_full_n)
    begin
                ap_block_pp0_stage0_subdone <= (((q_stream_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1)) or ((icmp_ln18_reg_119 = ap_const_lv1_0) and (m_axi_inout2_RVALID = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)));
    end process;

        ap_block_state1_pp0_stage0_iter0 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_state2_pp0_stage0_iter1_assign_proc : process(m_axi_inout2_RVALID, icmp_ln18_reg_119)
    begin
                ap_block_state2_pp0_stage0_iter1 <= ((icmp_ln18_reg_119 = ap_const_lv1_0) and (m_axi_inout2_RVALID = ap_const_logic_0));
    end process;


    ap_block_state3_pp0_stage0_iter2_assign_proc : process(q_stream_full_n)
    begin
                ap_block_state3_pp0_stage0_iter2 <= (q_stream_full_n = ap_const_logic_0);
    end process;
    ...
    begin
        if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln18_fu_84_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone))) then 
    ...
    ap_condition_exit_pp0_iter1_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln18_reg_119, ap_block_pp0_stage0_subdone)
    begin
        if (((icmp_ln18_reg_119 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone))) then 
    ...
    icmp_ln18_fu_84_p2 <= "1" when (ap_sig_allocacmp_indvar_flatten_load = ap_const_lv12_C18) else "0";

    inout2_blk_n_R_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, m_axi_inout2_RVALID, icmp_ln18_reg_119, ap_block_pp0_stage0)
    begin
        if (((icmp_ln18_reg_119 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
    ...
    m_axi_inout2_RREADY_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln18_reg_119, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln18_reg_119 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
    ...
    q_stream_blk_n_assign_proc : process(ap_enable_reg_pp0_iter2, q_stream_full_n, ap_block_pp0_stage0)
    begin
    ...
    q_stream_din <= inout2_addr_read_reg_123;

    q_stream_write_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001)
    begin
        if (((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
            q_stream_write <= ap_const_logic_1;
        else 
