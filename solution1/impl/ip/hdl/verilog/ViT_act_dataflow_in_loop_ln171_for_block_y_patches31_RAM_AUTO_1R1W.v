...
`timescale 1ns/1ps
module ViT_act_dataflow_in_loop_ln171_for_block_y_patches31_RAM_AUTO_1R1W
#(parameter
    DataWidth    = 512,
    AddressRange = 192,
    AddressWidth = 8,
...
generate
    for (i = 0; i < BufferCount; i = i + 1) begin : gen_buffer
        ViT_act_dataflow_in_loop_ln171_for_block_y_patches31_RAM_AUTO_1R1W_memcore ViT_act_dataflow_in_loop_ln171_for_block_y_patches31_RAM_AUTO_1R1W_memcore_U (
            .ce0      ( buf_ce0[i] ),
            .we0      ( buf_we0[i] ),
            .address0 ( buf_a0[i] ),
            .d0       ( buf_d0[i] ),
