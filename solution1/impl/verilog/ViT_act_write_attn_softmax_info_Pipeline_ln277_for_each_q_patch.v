...
module ViT_act_write_attn_softmax_info_Pipeline_ln277_for_each_q_patch (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [0:0] icmp_ln277_reg_118;
reg    ap_block_state2_pp0_stage0_iter1;
wire    ap_block_state3_pp0_stage0_iter2;
reg    ap_block_pp0_stage0_subdone;
wire   [0:0] icmp_ln277_fu_84_p2;
...
reg   [255:0] attn_softmax_info_stream_read_reg_127;
reg    ap_condition_exit_pp0_iter1_stage0;
reg    ap_block_pp0_stage0_01001;
reg   [7:0] q_patch_fu_48;
wire   [7:0] add_ln277_fu_90_p2;
wire    ap_loop_init;
reg   [7:0] ap_sig_allocacmp_q_patch_1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln277_fu_84_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln277_reg_118 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        attn_softmax_info_stream_read_reg_127 <= attn_softmax_info_stream_dout;
    end
end

always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln277_fu_84_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
always @ (*) begin
    if (((icmp_ln277_reg_118 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b0 == ap_block_pp0_stage0))) begin
        ap_sig_allocacmp_q_patch_1 = 8'd0;
    end else begin
...
always @ (*) begin
    if (((icmp_ln277_reg_118 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln277_reg_118 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
assign add_ln277_fu_90_p2 = (ap_sig_allocacmp_q_patch_1 + 8'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((icmp_ln277_reg_118 == 1'd0) & (attn_softmax_info_stream_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((icmp_ln277_reg_118 == 1'd0) & (attn_softmax_info_stream_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((m_axi_inout4_WREADY == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((icmp_ln277_reg_118 == 1'd0) & (attn_softmax_info_stream_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((m_axi_inout4_WREADY == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)));
end

assign ap_block_state1_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((icmp_ln277_reg_118 == 1'd0) & (attn_softmax_info_stream_empty_n == 1'b0));
end
...
assign icmp_ln277_fu_84_p2 = ((ap_sig_allocacmp_q_patch_1 == 8'd129) ? 1'b1 : 1'b0);
...
assign m_axi_inout4_WDATA = attn_softmax_info_stream_read_reg_127;

assign m_axi_inout4_WID = 1'd0;

assign m_axi_inout4_WLAST = 1'b0;

assign m_axi_inout4_WSTRB = 32'd4294967295;

assign m_axi_inout4_WUSER = 1'd0;

endmodule //ViT_act_write_attn_softmax_info_Pipeline_ln277_for_each_q_patch
